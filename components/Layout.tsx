          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-center gap-2"><MapPin size={16} /> Handwerkstraße 1, 10115 Berlin</li>
                <li className="flex items-center gap-2"><Phone size={16} /> +49 30 12345678</li>
