  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von handwerk-stellenangebote.com. Mit jahrelanger Erfahrung im
      ...
      <div className="autorenbox-links">
        <a href="https://handwerk-stellenangebote.com/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
